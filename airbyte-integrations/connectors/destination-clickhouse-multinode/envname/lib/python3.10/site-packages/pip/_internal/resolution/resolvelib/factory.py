...
from pip._internal.req.req_install import InstallRequirement, check_invalid_constraint_type
...
from .requirements import ExplicitRequirement, RequiresPythonRequirement, SpecifierRequirement, UnsatisfiableRequirement
...
class Factory:
    ...
    def _make_extras_candidate(self, base: BaseCandidate, extras: FrozenSet[str]) -> ExtrasCandidate:
    ...
    def _make_requirement_from_install_req(self, ireq: InstallRequirement, requested_extras: Iterable[str]) -> Optional[Requirement]:
    ...
    def make_requires_python_requirement(self, specifier: Optional[SpecifierSet]) -> Optional[Requirement]:
    ...
    def get_installation_error(
        ...
        msg = "Cannot install {} because these package versions " "have conflicting dependencies.".format(info)
        logger.critical(msg)
