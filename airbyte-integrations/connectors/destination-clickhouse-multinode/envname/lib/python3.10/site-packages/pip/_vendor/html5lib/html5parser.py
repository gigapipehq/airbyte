...
class HTMLParser(object):
    ...
    def __init__(self, tree=None, strict=False, namespaceHTMLElements=True, debug=False):
        ...
        self.phases = {name: cls(self, self.tree) for name, cls in getPhases(debug).items()}
    ...
    def isHTMLIntegrationPoint(self, element):
        if element.name == "annotation-xml" and element.namespace == namespaces["mathml"]:
            return "encoding" in element.attributes and element.attributes["encoding"].translate(asciiUpper2Lower) in (
                "text/html",
            ...
            while new_token is not None:
                ...
                if type == ParseErrorToken:
                    ...
                    if (
                        ...
                        or (self.isHTMLIntegrationPoint(currentNode) and type in (StartTagToken, CharactersToken, SpaceCharactersToken))
                    ):
                        phase = self.phase
                    else:
...
def getPhases(debug):
    ...
    class InitialPhase(Phase):
        ...
        def processDoctype(self, token):
            ...
            if (
                ...
                or publicId in ("-//w3o//dtd w3 html strict 3.0//en//", "-/w3c/dtd html 4.0 transitional/en", "html")
                or publicId.startswith(("-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"))
                ...
                publicId.startswith(("-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"))
                or publicId.startswith(("-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"))
    ...
    class InHeadPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher(
            [
                ...
                (("base", "basefont", "bgsound", "command", "link"), startTagBaseLinkCommand),
                ("meta", startTagMeta),
                ("head", startTagHead),
            ]
        )
    ...
    class AfterHeadPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher(
            [
                ...
                (("base", "basefont", "bgsound", "link", "meta", "noframes", "script", "style", "title"), startTagFromHead),
                ("head", startTagHead),
            ]
        )
        startTagHandler.default = startTagOther
    ...
    class InBodyPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher(
            [
                ...
                (("base", "basefont", "bgsound", "command", "link", "meta", "script", "style", "title"), startTagProcessInHead),
                ("body", startTagBody),
                ("frameset", startTagFrameset),
                (
                    (
                ...
                ("a", startTagA),
                (("b", "big", "code", "em", "font", "i", "s", "small", "strike", "strong", "tt", "u"), startTagFormatting),
                ("nobr", startTagNobr),
                ("button", startTagButton),
                (("applet", "marquee", "object"), startTagAppletMarqueeObject),
                ("xmp", startTagXmp),
                ("table", startTagTable),
                (("area", "br", "embed", "img", "keygen", "wbr"), startTagVoidFormatting),
                ...
                (("math"), startTagMath),
                (("svg"), startTagSvg),
                (("caption", "col", "colgroup", "frame", "head", "tbody", "td", "tfoot", "th", "thead", "tr"), startTagMisplaced),
            ]
        )
        startTagHandler.default = startTagOther
        ...
        endTagHandler = _utils.MethodDispatcher(
            [
                ...
                (("a", "b", "big", "code", "em", "font", "i", "nobr", "s", "small", "strike", "strong", "tt", "u"), endTagFormatting),
        ...
        def endTagCaption(self, token):
            if not self.ignoreEndTagCaption():
                ...
                if self.tree.openElements[-1].name != "caption":
                    self.parser.parseError(
                        "expected-one-end-tag-but-got-another", {"gotName": "caption", "expectedName": self.tree.openElements[-1].name}
                    )
    ...
    class InForeignContentPhase(Phase):
        ...
        def processStartTag(self, token):
            ...
            if token["name"] in self.breakoutElements or (
                token["name"] == "font" and set(token["data"].keys()) & {"color", "face", "size"}
            ):
    ...
    class InFramesetPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher(
            [("html", Phase.startTagHtml), ("frameset", startTagFrameset), ("frame", startTagFrame), ("noframes", startTagNoframes)]
        )
        startTagHandler.default = startTagOther
    ...
    class AfterAfterFramesetPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher([("html", startTagHtml), ("noframes", startTagNoFrames)])
        startTagHandler.default = startTagOther
