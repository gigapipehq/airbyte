...
from .util import FileOperator, convert_path, get_executable, get_export_entry, in_venv
    ...
    def _get_shebang(self, encoding, post_interp=b"", options=None):
        ...
        if self.executable:
            ...
            executable = os.path.join(
                sysconfig.get_config_var("BINDIR"), "python%s%s" % (sysconfig.get_config_var("VERSION"), sysconfig.get_config_var("EXE"))
            )
        if options:
