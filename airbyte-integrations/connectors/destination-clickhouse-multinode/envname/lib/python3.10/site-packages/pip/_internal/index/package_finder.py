        ...
        if link.egg_fragment:
            ...
            if ext == WHEEL_EXTENSION:
                ...
                if not wheel.supported(supported_tags):
                    ...
                    reason = "none of the wheel's tags ({}) are compatible " "(run pip debug --verbose to show compatible tags)".format(
                        ", ".join(file_tags)
                    )
                    return (False, reason)
...
class PackageFinder:
    ...
    def find_requirement(self, req: InstallRequirement, upgrade: bool) -> Optional[InstallationCandidate]:
        ...
        if installed_version and (best_candidate is None or best_candidate.version <= installed_version):
            best_installed = True
