...
from pip._internal.network.lazy_wheel import HTTPRangeRequestUnsupported, dist_from_wheel_url
...
class RequirementPreparer:
    ...
    def _prepare_linked_requirement(self, req, parallel_builds):
        ...
        if link.is_existing_dir() and self.in_tree_build:
            ...
            try:
                local_file = unpack_url(link, req.source_dir, self._download, self.download_dir, hashes)
