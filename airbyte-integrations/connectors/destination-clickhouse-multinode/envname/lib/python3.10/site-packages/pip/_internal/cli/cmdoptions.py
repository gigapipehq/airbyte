...
def _handle_merge_hash(option: Option, opt_str: str, value: str, parser: OptionParser) -> None:
    ...
    try:
        ...
        parser.error("Arguments to {} must be a hash name " "followed by a value, like --hash=sha256:" "abcde...".format(opt_str))  # noqa
    if algo not in STRONG_HASHES:
        parser.error("Allowed hash algorithms for {} are {}.".format(opt_str, ", ".join(STRONG_HASHES)))  # noqa
