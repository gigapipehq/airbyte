...
from pip._internal.configuration import Configuration, Kind, get_configuration_files, kinds
...
class ConfigurationCommand(Command):
    ...
    def add_options(self) -> None:
        ...
        self.cmd_opts.add_option(
            "--global", dest="global_file", action="store_true", default=False, help="Use the system-wide configuration file only"
        )

        self.cmd_opts.add_option(
            "--user", dest="user_file", action="store_true", default=False, help="Use the user configuration file only"
        )

        self.cmd_opts.add_option(
            "--site", dest="site_file", action="store_true", default=False, help="Use the current environment configuration file only"
        )
