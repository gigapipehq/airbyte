...
filemode_table = (
    ((S_IFLNK, "l"), (S_IFREG, "-"), (S_IFBLK, "b"), (S_IFDIR, "d"), (S_IFCHR, "c"), (S_IFIFO, "p")),
    ((TUREAD, "r"),),
    ((TUWRITE, "w"),),
...
class TarFile(object):
    ...
    OPEN_METH = {"tar": "taropen", "gz": "gzopen", "bz2": "bz2open"}  # uncompressed tar  # gzip compressed tar  # bzip2 compressed tar
