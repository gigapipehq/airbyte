...
from . import _utils
from .constants import EOF, _ReparseException, asciiLetters, asciiUppercase, spaceCharacters
...
if _utils.supports_lone_surrogates:
    ...
    invalid_unicode_re = re.compile(invalid_unicode_no_surrogate[:-1] + eval('"\\uD800-\\uDFFF"') + "]")  # pylint:disable=eval-used
else:
...
def HTMLInputStream(source, **kwargs):
    ...
    if (
        ...
        (isinstance(source, urllib.response.addbase) and isinstance(source.fp, http_client.HTTPResponse))
    ):
        isUnicode = False
