...
class MetadataInconsistent(InstallationError):
    ...
    def __str__(self):
        # type: () -> str
        template = "Requested {} has inconsistent {}: " "filename has {!r}, but metadata has {!r}"
...
class InstallationSubprocessError(InstallationError):
    ...
    def __str__(self):
        # type: () -> str
        return ("Command errored out with exit status {}: {} " "Check the logs for full command output.").format(
            self.returncode, self.description
        )
...
class HashMismatch(HashError):
    ...
    def _hash_comparison(self):
        ...
        for hash_name, expecteds in self.allowed.items():
            ...
            lines.extend(("        Expected {} {}".format(next(prefix), e)) for e in expecteds)
