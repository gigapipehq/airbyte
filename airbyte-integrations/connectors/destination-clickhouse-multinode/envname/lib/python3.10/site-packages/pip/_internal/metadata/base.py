...
import logging
import re
from typing import TYPE_CHECKING, Collection, Container, Iterable, Iterator, List, Optional, Union

from pip._internal.models.direct_url import DIRECT_URL_METADATA_NAME, DirectUrl, DirectUrlValidationError
