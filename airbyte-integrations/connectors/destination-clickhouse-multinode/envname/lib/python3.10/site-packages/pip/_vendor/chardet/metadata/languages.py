...
class Language(object):
    ...
    def __repr__(self):
        return "{}({})".format(
            self.__class__.__name__, ", ".join("{}={!r}".format(k, v) for k, v in self.__dict__.items() if not k.startswith("_"))
        )
...
LANGUAGES = {
    ...
    "Belarusian": Language(
        ...
        alphabet=("АБВГДЕЁЖЗІЙКЛМНОПРСТУЎФХЦЧШЫЬЭЮЯ" "абвгдеёжзійклмнопрстуўфхцчшыьэюяʼ"),
    ...
    "Greek": Language(
        ...
        alphabet=("αβγδεζηθικλμνξοπρσςτυφχψωάέήίόύώ" "ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΣΤΥΦΧΨΩΆΈΉΊΌΎΏ"),
        wiki_start_pages=["Πύλη:Κύρια"],
    ),
    "English": Language(
        name="English", iso_code="en", use_ascii=True, charsets=["ISO-8859-1", "WINDOWS-1252"], wiki_start_pages=["Main_Page"]
    ),
    "Esperanto": Language(
        name="Esperanto",
        iso_code="eo",
    ...
    "Latvian": Language(
        ...
        alphabet=("AĀBCČDEĒFGĢHIĪJKĶLĻMNŅOPRSŠTUŪVZŽ" "aābcčdeēfgģhiījkķlļmnņoprsštuūvzž"),
    ...
    "Dutch": Language(
        name="Dutch", iso_code="nl", use_ascii=True, charsets=["ISO-8859-1", "WINDOWS-1252"], wiki_start_pages=["Hoofdpagina"]
    ),
    "Polish": Language(
        name="Polish",
        iso_code="pl",
        ...
        use_ascii=False,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet=("AĄBCĆDEĘFGHIJKLŁMNŃOÓPRSŚTUWYZŹŻ" "aąbcćdeęfghijklłmnńoóprsśtuwyzźż"),
    ...
    "Turkish": Language(
        ...
        alphabet=("abcçdefgğhıijklmnoöprsştuüvyzâîû" "ABCÇDEFGĞHIİJKLMNOÖPRSŞTUÜVYZÂÎÛ"),
