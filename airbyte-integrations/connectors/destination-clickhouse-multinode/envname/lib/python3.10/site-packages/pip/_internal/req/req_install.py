...
class InstallRequirement:
    ...
    def check_if_exists(self, use_user_site: bool) -> None:
        ...
        version_compatible = existing_version is not None and self.req.specifier.contains(existing_version, prereleases=True)
            ...
            if use_user_site:
                if dist_in_usersite(existing_dist):
                    ...
                    raise InstallationError(
                        ...
                        "lack sys.path precedence to {} in {}".format(existing_dist.project_name, existing_dist.location)
                    )
            else:
                self.should_reinstall = True
        else:
    ...
    def _generate_metadata(self) -> str:
        ...
        if not self.use_pep517:
            ...
            if not os.path.exists(self.setup_py_path):
                raise InstallationError(f'File "setup.py" not found for legacy project {self}.')
    ...
    def archive(self, build_dir: Optional[str]) -> None:
        ...
        if os.path.exists(archive_path):
            response = ask_path_exists(
                "The file {} exists. (i)gnore, (w)ipe, " "(b)ackup, (a)bort ".format(display_path(archive_path)), ("i", "w", "b", "a")
            )
            if response == "i":
        ...
        if success and self.legacy_install_reason == 8368:
            deprecated(
                reason=(
                    ...
                    "method, because a wheel could not be built for it.".format(self.name)
                ),
