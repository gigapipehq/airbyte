...
def make_install_req_from_dist(dist: Distribution, template: InstallRequirement) -> InstallRequirement:
...
class LinkCandidate(_InstallRequirementBackedCandidate):
    ...
    def __init__(
        ...
        if cache_entry is not None and cache_entry.persistent and template.link is template.original_link:
    ...
    def _prepare_distribution(self) -> Distribution:
        return self._factory.preparer.prepare_linked_requirement(self._ireq, parallel_builds=True)
