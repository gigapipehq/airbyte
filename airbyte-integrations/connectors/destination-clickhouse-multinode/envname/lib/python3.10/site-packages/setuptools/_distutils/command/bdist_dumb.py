...
class bdist_dumb(Command):
    ...
    user_options = [
        ...
        ("format=", "f", "archive format to create (tar, gztar, bztar, xztar, " "ztar, zip)"),
        ...
        if not self.relative:
            ...
            if self.distribution.has_ext_modules() and (install.install_base != install.install_platbase):
                raise DistutilsPlatformError(
                    ...
                    "base and platbase are different (%s, %s)" % (repr(install.install_base), repr(install.install_platbase))
                )
            else:
