...
from distutils.errors import CompileError, DistutilsExecError, DistutilsPlatformError, LibError, LinkError
    ...
    def _remove_visual_c_ref(self, manifest_file):
        try:
            ...
            try:
                ...
                manifest_f.close()
            pattern = re.compile(
                r"""<assemblyIdentity.*?name=("|')Microsoft\.""" r"""VC\d{2}\.CRT("|').*?(/>|</assemblyIdentity>)""", re.DOTALL
            )
            ...
            pattern = re.compile(r"""<assemblyIdentity.*?name=(?:"|')(.+?)(?:"|')""" r""".*?(?:/>|</assemblyIdentity>)""", re.DOTALL)
