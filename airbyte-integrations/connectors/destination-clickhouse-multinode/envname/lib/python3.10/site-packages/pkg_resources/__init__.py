...
class WorkingSet:
    ...
    def resolve(self, requirements, env=None, installer=None, replace_conflicting=False, extras=None):  # noqa: C901
...
class Distribution:
    ...
    def from_location(cls, location, basename, metadata=None, **kw):
        ...
        return cls(
            location, metadata, project_name=project_name, version=version, py_version=py_version, platform=platform, **kw
        )._reload_version()
